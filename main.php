...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/bgblue.jpg); width:100%; height: 656px;"></div>
			<!-- /Backgound Image -->
						...
						<div class="col-md-8">
							...
							<?php
								...
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Discover yourself<br>Bridging The Gap Between The Students And Industry</b></p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Career-Guidance.com</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Career-Guidance.com</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<?php endif ?>
								...
								<p>Take the test to find the perfect role for you after your Graduation.</p>
							</div>
						</div>
					</div>
					<!-- /feature -->
					...
					<div class="col-md-4">
						...
						<i class="feature-icon fa "><span>&#x1F50E;&#xFE0E;</span></i>
							<div class="feature-content">
								...
								<p>Gain knowledge through various sources, like important informational links, access to study materials, build network through your alumini etc.</p>
							</div>
						</div>
					</div>
					<!-- /feature -->
		...
		<div id="cta" class="section" style="height: 400px;">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/bgblue.jpg)"></div>
			<!-- /Backgound Image -->
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="section-header">
							<h2 style="font-size: 35px;">About Career-Guidance.com</h2>
					...
					<div class="col-md-6">
						<div class="about-img">
							<img src="./img/bg1.jpg" width="510" height="450" alt="">
						</div>
					</div>
